 ...
 * PRIVATE VARIABLES                                                            *
 ******************************************************************************/
static unsigned int AD1PCFG_MASKS[NUM_AD_PINS] = {ENABLE_AN2_ANA, ENABLE_AN4_ANA,
    ENABLE_AN8_ANA, ENABLE_AN10_ANA, ENABLE_AN12_ANA, ENABLE_AN14_ANA};

static unsigned int AD1CSSL_MASKS[NUM_AD_PINS] = {SKIP_SCAN_AN2, SKIP_SCAN_AN4,
    SKIP_SCAN_AN8, SKIP_SCAN_AN10, SKIP_SCAN_AN12, SKIP_SCAN_AN14};

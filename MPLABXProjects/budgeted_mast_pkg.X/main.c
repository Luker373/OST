...
int main(void){
    ...
    while(1){
        ...
        //PutChar(2, IsTransmitEmpty(2) + 48);
//        if(IsTransmitEmpty(2)){
//            if(test == 0){
...
//            
//            
//            // LUKE: what does this "working version" mean??? why is it commented out if its working??

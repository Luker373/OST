...
char LSM9DS1_Init(void){
	...
	I2C_WriteReg(LSM9DS1_GYR_ADDRESS,LSM9DS1_CTRL_REG1_G,0b10100000);    // Gyro ODR = 476Hz, 245 dps,  8.75 mdps/LSB
	//I2C_WriteReg(LSM9DS1_GYR_ADDRESS,LSM9DS1_CTRL_REG1_G,0b10101000);    // Gyro ODR = 476Hz, 500 dps,  17.50 mdps/LSB
    ...
    I2C_WriteReg(LSM9DS1_ACC_ADDRESS,LSM9DS1_CTRL_REG6_XL,0b00100000);   // +/- 2g
...
int LSM9DS1_ReadAccelX(void){
	int accX = 0;
	accX |= I2C_ReadInt(LSM9DS1_ACC_ADDRESS, LSM9DS1_OUT_X_L_XL, FALSE);	
	return accX;
}
...
int LSM9DS1_ReadAccelZ(void){
	int accZ = 0;
	accZ |= I2C_ReadInt(LSM9DS1_ACC_ADDRESS, LSM9DS1_OUT_Z_L_XL, FALSE);
	return accZ;
}
